                            ...
                            <div class="movie-container">
                                ...
                                <div class="content-movie">
                                    ...
                                    <div class="infor-movie">
                                        ...
                                        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="yellow" class="bi bi-clock" viewBox="0 0 16 16">
                                                <path
                                        ...
                                        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="yellow" class="bi bi-globe-asia-australia" viewBox="0 0 16 16">
                                                <path
                                        ...
                                        {{-- <p><i class="bi bi-chat-left-dots"></i> {{ $movie->language }}</p> --}}
                                        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="yellow" class="bi bi-chat-left-dots" viewBox="0 0 16 16">
                                                <path
