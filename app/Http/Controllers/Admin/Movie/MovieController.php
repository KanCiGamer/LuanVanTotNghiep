...
class MovieController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.movie.movie', compact('movies', 'categories', 'age_rating'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // if(in_array($imagePath->getClientOriginalExtension(),['jpg','jpeg', 'png','gif']))
        // {
        //     $imageName = $imagePath->getClientOriginalName();
        //     $tempPath = $imagePath->getPathname();
        //     $imagick = new \Imagick($tempPath);
        //     $imagick->resizeImage(750, 1117, \Imagick::FILTER_LANCZOS, 1);
        ...
        $imageName = $imagePath->getClientOriginalName();
        $imagePath->move('images/movies', $imageName);
